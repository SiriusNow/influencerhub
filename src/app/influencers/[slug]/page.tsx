...
const InfluencerDetails = ({ influencer, user, services }: any) => {
  const service = services.find(
    (service: any) => service._id === influencer.service_id
  );

  return (
    <div className=" my-10 bg-white flex flex-col items-center rounded-xl border px-4 py-4 text-center md:flex-row md:items-start md:text-left">
      ...
      >
        <div className="p-4 md:p-12 text-center lg:text-left">
          <h1 className="text-3xl font-bold pt-8 lg:pt-0">{influencer.name}</h1>
          ...
          <p className="pt-8 text-sm">{service.description}</p>
