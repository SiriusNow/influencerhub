...
export default function Influencers({ influencer, services }: any) {
  const service = services.find(
    (service: any) => service._id === influencer.service_id
  );

  return (
    <Link href={`/influencers/${influencer._id}`}>
      <div className="mx-auto my-4 bg-white flex max-w-xs flex-col items-center rounded-xl border px-4 py-4 text-center md:max-w-lg md:flex-row md:items-start md:text-left">
        <div className="mb-4 md:mr-6 md:mb-0 w-full md:w-1/3">
          <img
        ...
        <div className="p-5 w-full md:w-2/3">
          ...
          <br />
          <span className="mt-3 mb-4 text-gray-500 dark:text-gray-400">
            {service.name}
          </span>
